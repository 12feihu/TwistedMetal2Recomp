# TwistedMetal2 Recompiled

<!-- retcomm-readme-metrics -->
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/local/TwistedMetal2Recomp/total)](https://github.com/local/TwistedMetal2Recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/local/TwistedMetal2Recomp/latest/total)](https://github.com/local/TwistedMetal2Recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/local/TwistedMetal2Recomp)](https://github.com/local/TwistedMetal2Recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **TwistedMetal2** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

Static recompilation of Twisted Metal 2 (SCUS-94306).
...
Zip prefix for CI artifacts: `twistedmetal2`.
