...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "TwistedMetal2",
    .project_root_env = "TWISTEDMETAL2RECOMP_PROJECT_ROOT",
    .build_dir_env = "TWISTEDMETAL2RECOMP_BUILD_DIR",
    .force_setup_env = "TWISTEDMETAL2RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCUS_943.06_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "TwistedMetal2_Recompiled",
    .prepare_note =
